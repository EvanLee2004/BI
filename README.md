...
| 版本 | 架构 | 质量 |
|:---:|:---:|:---:|
| **v1.5.0-beta** | 五层单向 · 看端+管理端 static · 金额 INTEGER 分 · WAL 单事务重建 | 回归红线 32 周期 · golden 数字全等 · 测试 500+ |
...
> **图集与代码对齐说明（2026-07-15 · v1.5）**  
> 对照 `VERSION=1.5.0-beta`：五层架构 / 登录分流 / 部署拓扑 / 模块图 / 时序 / ER **均为当前代码现状**。  
