...
>
> 开发号 **v8.7.3** · 产品版本 **v1.0（公测 Beta）**·周一上线版 · 测试 **306** 全绿 · 回归红线 32 周期一分不差
> 2026-07-12 批次：产品版本号+更新日志页(v8.4) · 多次更新时间(v8.5) · 账号可绑多个 BU(v8.6) · 一键更新+看门狗(v8.7) · 对标 Gitee(v8.7.1)
> 2026-07-13：产品升 **公测 Beta**（VERSION=1.0-beta）+ code review 修 #1(收单月份越界校验) + **一键更新补依赖自动安装 & 坏版本自动回滚**(v8.7.3)
