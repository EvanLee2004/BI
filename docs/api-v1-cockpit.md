...
`/api/v1/admin/manual*` `/api/v1/admin/alloc_rates` `/api/v1/admin/detax_rates` `/api/v1/admin/detail` `/api/v1/admin/refresh*` `/api/v1/admin/settings` `/api/update/*` 等**保留**，行为与 v1.3.1 一致。
