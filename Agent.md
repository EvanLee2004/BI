...
## 当前状态（3.3.2 · 2026-07-30）

- **版本**：`VERSION` = **3.3.2**（管理端更新诚实态 + 体检浮层 fixed/内滚可读）。其上：3.3.1 分摊 int 分；3.3.0 用户统计；3.2.0 server 薄门面；3.1.0/3.0.0 去 render 双轨；2.7.x API v1 + sid-only + 维护页。
